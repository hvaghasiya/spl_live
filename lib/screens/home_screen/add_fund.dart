  ...
  class _AddFundState extends State<AddFund> with WidgetsBindingObserver {
    ...
    final String promotionalVideoLink = "assets/video/video.mp4";
  
    // final String promotionalVideoLink =
    //     "https://www.youtube.com/watch?v=2ky-tWGD13Q";
    ...
    Future<void> processPayment(String amount) async {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (jsonResponse['status'] == true) {
            ...
            if (response.statusCode == 401 ||
                jsonResponse['message'] == "Access Denied!") {
              AppUtils.showErrorSnackBar(
                  bodyText: "Session Expired. Please Login Again.");
            } else {
              AppUtils.showErrorSnackBar(
                  bodyText:
                      jsonResponse['message'] ?? "Failed to initiate payment");
            }
          }
        } else {
          AppUtils.showErrorSnackBar(
              bodyText: "Server Error: ${response.statusCode}");
        }
      } catch (e) {
        setState(() {
          isProcessing = false;
        ...
        print("Error: $e");
        AppUtils.showErrorSnackBar(
            bodyText: "Connection Error. Check internet/server.");
      }
    }
                  ...
                  () => Wrap(
                    ...
                    children: List.generate(
                      ...
                      (index) => Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            homeCon.newTicketsList.forEach(
                                (element) => element.isSelected.value = false);
                            homeCon.addFundCon.text =
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: CustomTextStyle.textRobotoMedium.copyWith(
                                  fontSize: 16,
                                  color: homeCon
                                          .newTicketsList[index].isSelected.value
                                      ? AppColors.white
                                      : AppColors.black,
                                  fontWeight: FontWeight.bold,
                                ),
